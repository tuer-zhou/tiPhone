var State_t;
(function (State_t) {
    State_t[State_t["IDLE"] = 0] = "IDLE";
    State_t[State_t["RINGING"] = 1] = "RINGING";
    State_t[State_t["DIALING"] = 2] = "DIALING";
    State_t[State_t["WAITING"] = 3] = "WAITING";
    State_t[State_t["CALLING"] = 4] = "CALLING";
    State_t[State_t["END"] = 5] = "END";
})(State_t || (State_t = {}));
;
var state = State_t.IDLE;
var handset = $("#handset");
...
function handleNumberInput(number) {
    ...
    var dstPhoneNumber = String(numberField.val());
